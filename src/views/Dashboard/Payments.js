...
=======
    if (
      ...
      options["metadata"]["customer_email"] = document.querySelector(
...
>>>>>>> b92e44f5b6d6f50f756834cc0a047b9ffa71f826
        ...
        if (
          ...
          data["created"] = {
            ...
            operator: options.date.operator,
          };
        }

        if (
          options.amount.value !== null &&
          options.amount !== null &&
          options.amount !== undefined
        ) {
          data["amount"] = {
            value: options.amount.value,
            operator: options.amount.operator,
          };
        }
        ...
        if (
          options.metadata.site_url !== null &&
        ...
        if (
          options.metadata.customer_email !== null &&
          options.metadata !== undefined
        ) {
          data["metadata"] = {
            ...data["metadata"],
            customer_email: options.metadata.customer_email,
          };
        }
        console.log(data);
      }
